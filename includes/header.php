...
<div class="splash-screen">
    <img src="../assets/images/NutriLogo.png" alt="NutriCoach" class="splash-logo">
...
<nav class="mobile-bottom-nav">
    ...
    <a href="workout-plan-improved.php" class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'workout-plan-improved.php' ? 'active' : ''; ?>">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="chat.php" class="nav-item nav-item-center <?php echo basename($_SERVER['PHP_SELF']) == 'chat.php' ? 'active' : ''; ?>">
